		  ...
		  rules: [
			  ...
			  [
				  ...
				  ([, property, length], {theme}) => {
					  ...
					  switch (prop) {
						  case 'p': prop = 'padding'; break;
						  case 'm': prop = 'margin'; break;
						  case 'pr': case 'p-r': prop = 'padding-right'; break;
						  case 'pl': case 'p-l': prop = 'padding-left'; break;
						  case 'pt': case 'p-t': prop = 'padding-top'; break;
						  case 'pb': case 'p-b': prop = 'padding-bottom'; break;
						  case 'mr': case 'm-r': prop = 'margin-right'; break;
						  case 'ml': case 'm-l': prop = 'margin-left'; break;
						  case 'mt': case 'm-t': prop = 'margin-top'; break;
						  case 'mb': case 'm-b': prop = 'margin-bottom'; break;
						  case 'px': case 'p-x': prop = 'padding-left'; prop2 = 'padding-right'; break;
						  case 'py': case 'p-y': prop = 'padding-top'; prop2 = 'padding-bottom'; break;
						  case 'mx': case 'm-x': prop = 'margin-left'; prop2 = 'margin-right'; break;
						  case 'my': case 'm-y': prop = 'margin-top'; prop2 = 'margin-bottom'; break;
					  }
					  const output = {};
